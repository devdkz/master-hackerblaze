...
export default function BrancoDuplo( access_token, user ) {
    ...
    const getRandomImage = () => {
        const listImages = [
            "https://blaze1.space/static/media/black-0.037f1400.svg",
            "https://blaze1.space/static/media/red-0.9cca36d9.svg",
    ...
    const handleConfirmarSinal = async () => {
        ...
        if (chance < 0.7) {
            ...
            horario3Minutos.setMinutes(agora.getMinutes() + 2);
