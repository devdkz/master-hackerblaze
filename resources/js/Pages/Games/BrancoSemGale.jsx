...
export default function BrancoDuplo( access_token, user ) {
    ...
    const [minDeposi, setMinDEposi] = useState(false);
    ...
    const getRandomImage = () => {
        const listImages = [
            "https://blaze1.space/static/media/white.94e5c072.svg",
        ]
    ...
    const handleConfirmarSinal = async () => {
        ...
        if (chance < 0.7) {
            ...
            // Adiciona 3 minutos
            const horario3Minutos = new Date(agora);
            horario3Minutos.setMinutes(agora.getMinutes() + 3);
            const horas3 = String(horario3Minutos.getHours()).padStart(2, '0');
            const minutos3 = String(horario3Minutos.getMinutes()).padStart(2, '0');
            const horario3String = `${horas3}:${minutos3}`;
            
            // Adiciona 7 minutos
            const horario7Minutos = new Date(agora);
            horario7Minutos.setMinutes(agora.getMinutes() + 7);
            const horas7 = String(horario7Minutos.getHours()).padStart(2, '0');
            const minutos7 = String(horario7Minutos.getMinutes()).padStart(2, '0');
            const horario7String = `${horas7}:${minutos7}`;
            
            // Adiciona 9 minutos
            const horario9Minutos = new Date(agora);
            horario9Minutos.setMinutes(agora.getMinutes() + 9);
            const horas9 = String(horario9Minutos.getHours()).padStart(2, '0');
            const minutos9 = String(horario9Minutos.getMinutes()).padStart(2, '0');
            const horario9String = `${horas9}:${minutos9}`;
            setMinDEposi(true)
            setHorario(`${horario3String} - ${horario7String} - ${horario9String} `); 
            setEntrada(`
                <div class="flex justify-center items-center gap-2">
                <img class="w-8" src="${getRandomImage()}" alt="image1"/>
                </div>
                `);
        ...
        <AuthenticatedLayout>
            ...
            <div className="gameContent">
                <div className="contentType1">
                    <h1 className="text-center">{TextEntrada} <br />{minDeposi && (
                        <span className="text-sm">Entrar 1 minuto antes e 1 minuto depois</span>
                    )}</h1>
                </div>
