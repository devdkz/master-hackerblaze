...
return [
    ...
    */
    ...
    | Basta usar o nome da regra como chave, seguido pelo nome do atributo. Por exemplo:
    |
    | 'nome_atributo.regra' => 'Mensagem personalizada',
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar o espaço reservado de atributos
    | com algo mais amigável para o usuário, como "Endereço de E-mail" em vez de "email".
    |
    */
